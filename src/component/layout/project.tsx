    ...
    <div className='md:px-[2%]'>
        <div className='md:flex md:relative'>
            <div className='md:w-1/2 '>
                ...
                <h1 className='text-[3rem] md:text-4xl'>Fashion Hub</h1>
                <p className='my-12  md:absolute md:right-[45%] md:z-10 bg-[#432043] backdrop-blur-md shadow-md p-10 leading-loose rounded-xl text-lg'>A web app for visualizing fashion data. View your various latest styles, materials, sewing equipements and detailed fashion information about each style. Add and purchase new items of recommended styles based on the existing trends and more.</p>
                <div className='flex md:absolute md:bottom-0 cursor-pointer'>
                     <a href="https://maracodez.github.io/FashionHub/">
                        <img src={icon} alt="" />
                    </a>
                   <a href="https://fashion-hub-five.vercel.app/">
                        <img src={icon} alt="" />
                   </a>
                </div>
            </div>
            <div className='md:w-1/2 relative shadow-lg mt-4'>
                {/* <img 
                    src={shadow} 
                    alt={shadow} 
                    className="hidden md:block  absolute right-0 left-46 top-[10%] bottom-[10%]"
                /> */}
        ...
        <div className='md:flex mt-14'>
            <div className=' md:hidden '>
                ...
                <div className='flex cursor-pointer'>
                    <a href="https://maracodez.github.io/dog-breed-api/">
                        <img src={icon} alt="" />
                    </a>
                   <a href="https://dog-breed-api-zeta.vercel.app/">
                        <img src={icon} alt="" />
                   </a>
                </div>
            </div>
            ...
            <div className='hidden md:block w-1/2 text-right md:relative'>
                ...
                <p className='my-14  md:absolute md:left-[-9%] md:z-10 bg-[#432043] backdrop-blur-md shadow-md p-10 leading-loose rounded-xl text-left'>A web app for visualizing animal(dog breed) specie. View your dog breeds, their specie, images, names and detailed information about each breed. Search desired dog breed which are not showcased on the dashboard and more.</p>
                <div className='flex md:absolute md:bottom-0 md:right-0 cursor-pointer'>
                    <a href="https://maracodez.github.io/dog-breed-api/">
                        <img src={icon} alt="" />
                    </a>
                   <a href="https://dog-breed-api-zeta.vercel.app/">
